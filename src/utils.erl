...
from_message(#message{message_id=MessageId,user_id = UserId,content = Content,topic_id=TopicId,created_at = CreatedAt})->
    #{message_id=>MessageId,topic_id=>TopicId,user_id=>UserId,content=>Content,created_at=>CreatedAt}.
