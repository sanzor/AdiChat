-file("/usr/local/lib/erlang/lib/parsetools-2.3/include/leexinc.hrl", 0).
...
-module(routing_tree_leex).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("/home/daniel/project/routing_tree/src/routing_tree_leex.xrl", 18).
...
-file("/usr/local/lib/erlang/lib/parsetools-2.3/include/leexinc.hrl", 14).
...
-file("/home/daniel/project/routing_tree/src/routing_tree_leex.erl", 312).
yystate() -> 11.
...
yystate(11, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(13, Ics, Line, Tlen+1, 9, Tlen);
yystate(11, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 34 ->
    yystate(13, Ics, Line, Tlen+1, 9, Tlen);
yystate(11, [C|Ics], Line, Tlen, _, _) when C >= 39, C =< 46 ->
    yystate(13, Ics, Line, Tlen+1, 9, Tlen);
...
-file("/home/daniel/project/routing_tree/src/routing_tree_leex.xrl", 4).
yyaction_0(TokenLine) ->
     { token, { divider, TokenLine } } .

-compile({inline,yyaction_1/2}).
-file("/home/daniel/project/routing_tree/src/routing_tree_leex.xrl", 5).
yyaction_1(TokenChars, TokenLine) ->
     { token, { binding, TokenLine, strip (TokenChars) } } .

-compile({inline,yyaction_2/1}).
-file("/home/daniel/project/routing_tree/src/routing_tree_leex.xrl", 6).
yyaction_2(TokenLine) ->
     { token, { wildcard, TokenLine, '...' } } .

-compile({inline,yyaction_3/1}).
-file("/home/daniel/project/routing_tree/src/routing_tree_leex.xrl", 7).
yyaction_3(TokenLine) ->
     { token, { optional_left, TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("/home/daniel/project/routing_tree/src/routing_tree_leex.xrl", 8).
yyaction_4(TokenLine) ->
     { token, { optional_right, TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("/home/daniel/project/routing_tree/src/routing_tree_leex.xrl", 9).
yyaction_5(TokenLine) ->
     { token, { query_start, TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("/home/daniel/project/routing_tree/src/routing_tree_leex.xrl", 10).
yyaction_6(TokenLine) ->
     { token, { ampersand, TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("/home/daniel/project/routing_tree/src/routing_tree_leex.xrl", 11).
yyaction_7(TokenLine) ->
     { token, { equals, TokenLine } } .

-compile({inline,yyaction_8/1}).
-file("/home/daniel/project/routing_tree/src/routing_tree_leex.xrl", 12).
yyaction_8(TokenLine) ->
     { token, { fragment, TokenLine } } .

-compile({inline,yyaction_9/2}).
-file("/home/daniel/project/routing_tree/src/routing_tree_leex.xrl", 13).
yyaction_9(TokenChars, TokenLine) ->
     { token, { segment, TokenLine, TokenChars } } .

-compile({inline,yyaction_10/1}).
-file("/home/daniel/project/routing_tree/src/routing_tree_leex.xrl", 14).
yyaction_10(TokenChars) ->
     { error, { unknown_symbol, TokenChars } } .

-file("/usr/local/lib/erlang/lib/parsetools-2.3/include/leexinc.hrl", 313).
